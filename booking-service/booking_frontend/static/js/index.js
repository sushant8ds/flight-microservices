document.addEventListener("DOMContentLoaded", () => {
    try {
        ...
        document.body.insertAdjacentHTML('afterbegin', `<div style='color:red;position:fixed;top:80px;left:0;z-index:9999;background:#fff;padding:10px;border:2px solid red;'>JS ERROR: ${e.message}</div>`);
