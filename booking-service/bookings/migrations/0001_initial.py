    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='booking_users', to='auth.group', verbose_name='groups')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depart_day', models.ManyToManyField(related_name='flights_of_the_day', to='bookings.week')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='bookings.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='bookings.passenger')),
